...
Les circuits appliqués sont les suivants :

- =Bon de sortie de fonds= : contrôle financier, visa du demandeur, responsable finances, DAF, comptabilité du projet, DG, puis préparation et exécution du paiement. L'approbation réserve le montant sur la ligne budgétaire du projet.
- =Demande d'achat= : DAF, DG, cellule achat, commande, réception, facture, puis paiement. Les commandes et réceptions utilisent les objets Odoo d'achat plutôt qu'une comptabilité parallèle.
