...
La rubrique =Projets= permet à tout agent de proposer un projet avec ses objectifs, dates, bailleur, partenaires et équipe. Après autorisation du DG et désignation du chef de projet, le dossier couvre neuf onglets : fiche projet, plan d'action, résultats, livrables, finances, conformité, risques, rapports et clôture. Le porteur ou le chef de projet ajoute et modifie les éléments tant que l'onglet n'est pas validé; les activités du plan d'action deviennent des tâches Odoo suivies avec leur charge et leur progression.

Chaque onglet suit le cycle =Brouillon → Soumis → Vérifié → Validé → Clôturé=. Le contrôleur peut demander une correction motivée. La validation finale appartient au DG, exige la phrase de confirmation affichée et crée une preuve électronique immuable. Une révision devenue ancienne est refusée.

* Procédures métier

La rubrique =Procédures= centralise les bons de sortie de fonds, demandes d'achat, absences, ordres de mission, notifications de paiement, visas et dossiers de gestion des données. Le formulaire adapte les champs au type choisi et accepte les justificatifs PDF, JPEG ou PNG. Le dossier indique l'étape courante, les actions autorisées et son journal d'événements.
